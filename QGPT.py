...
def get_completion(config, messages):
    ...
    response = {'id': 'chatcmpl-6xxbLHmF9H4prvSmsYUuUc0wgfkCS',
                'object': 'chat.completion', 'created': 1679748479,
...
def main():
    ...
    interaction_mode_group.add_argument(
        '-c', '--conversation', action="store_true", help="Enter conversational mode with the entered prompt")
    interaction_mode_group.add_argument('-m', '--memory', action="store_true",
